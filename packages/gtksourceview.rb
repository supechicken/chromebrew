require 'package'
PackageUtils.load_package("#{__dir__}/gtksourceview_3.rb")
PackageUtils.load_package("#{__dir__}/gtksourceview_4.rb")
PackageUtils.load_package("#{__dir__}/gtksourceview_5.rb")
